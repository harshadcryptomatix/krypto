      ...
      <div class="col-12">
        <div class="card">
          ...
          <tr>
            ...
            <td>
            {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $order->transaction_date)->format('d-m-Y / H:i:s') }}
            </td>
            <td><button type="button" class="btn btn-primary merchant-order-data" data-bs-toggle="modal"
