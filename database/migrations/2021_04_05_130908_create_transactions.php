...
class CreateTransactions extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->tinyInteger("mid_type")->nullable();
            ...
            $table->decimal('amount_in_usd', 10, 2)->default(0)->nullable();
            $table->integer('website_url_id')->nullable();
            ...
            $table->timestamp('pre_arbitration_date')->nullable();
            $table->string('pre_arbitration_sent_files')->nullable();
